...
//void vdaxpy(size_t n, double x[], double const y[], double const alpha, double const z[])
//{
//#pragma omp parallel for default(none) shared(x,y,z)  firstprivate(n)
    //for (size_t k = 0; k < n; ++k)
    //{
                  ...
                  double alpha, vector<double> const& z )
{
    ...
    //vdaxpy(n,x.data(),y.data(),alpha,z.data());
...
//double dscapr(size_t n, double const x[], double const y[])
//{
    //double    s = 0.0;
